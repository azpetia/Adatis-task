...
# Import the csv data 
dataset=read.csv("Adatis.Online.Sales.csv",sep=",",dec=".",na.strings = c("NA",""," ","  "),stringsAsFactors = F)
...
#Percantage Error
forecastOnlineSales = data.frame(dataset$price[899:990], finalforecastvalues)
col_headings=c("ActualPrice","ForecastedPrice")
names(forecastOnlineSales)=col_headings
attach(forecastOnlineSales)
percentage_error=((forecastOnlineSales$ActualPrice-forecastOnlineSales$ForecastedPrice)/forecastOnlineSales$ActualPrice)
percentage_error
